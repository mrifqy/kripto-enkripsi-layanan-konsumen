        ...
        <div class="mx-auto d-flex flex-lg-row flex-column hero">
          ...
          <div
            ...
            <h1 class="title-text-big">
              ...
              <span style="color: #4E91F9">HydroQua</span>?<br class="d-lg-block d-none" />
              
            </h1>
            <p class="text-caption">
              HydroQua adalah sebuah perusahaan air minum asal Indonesia yang menyediakan air pegunungan asli agar dapat dikonsumsi oleh seluruh lapisan masyarakat.
              <br class="d-sm-block d-none" />
              Kami berkomitmen untuk selalu memberikan kualitas air minum terbaik untuk seluruh pelanggan HydroQua.
            </p>
